...
const About: React.FC = () => {
  return (
    <div className="w-full max-w-sm p-6 bg-gray-800/50 rounded-lg space-y-6 text-center">
      <div>
        <h2 className="text-2xl font-bold text-indigo-400">P2P Video Call</h2>
        <p className="text-sm font-mono text-gray-500 mt-1">Version 1.2.0</p>
      </div>
