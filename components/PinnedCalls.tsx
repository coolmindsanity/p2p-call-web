    ...
    <div className="w-full space-y-3 max-h-96 overflow-y-auto pr-2 custom-scrollbar" role="list">
        {pins.map((pin, index) => {
          ...
          return (
            <div 
              key={pin.callId} 
              className="bg-gray-800 p-3 rounded-lg flex items-center justify-between gap-3 min-h-[70px] transition-colors duration-200 animate-fade-in-down border border-gray-700"
